...
from components.robots.robot_khepera3 import RobotKhepera3
...
if __name__ == '__main__':
    ...
    world.add_robot(RobotKhepera3(coordinate_x = 300, coordinate_y = 200), dimensions = {"width" : 20, "height" : 20}, color = (0, 0, 255))
    world.add_robot(RobotKhepera3(coordinate_x = 300, coordinate_y = 300), dimensions = {"width" : 20, "height" : 20}, color = (0, 255, 0))
